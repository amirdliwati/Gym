...
<div id="phoneval" class="ribbon-wrapper card">
    <div class="card-body">
        <div class="ribbon ribbon-bookmark ribbon-primary">{{__('Trainee Addresses')}}</div>
        <div class="form-group row  d-flex align-items-end">
            ...
            @foreach ($Trainee->addresses->where('add_type',1) as $address)
            <div class="col-md-4">
                <div class="col-md-12">
        ...
        @if ($Trainee->addresses->where('add_type',2)->count() > 0)
        @foreach ($Trainee->addresses->where('add_type',2) as $address)
            <div id="myDIV" >
                <div class="form-group row  d-flex align-items-end">
                    <div class="col-md-2">
                        <div class="form-group row">
        ...
        @endforeach
        @elseif ($Trainee->addresses->where('add_type',2) == '[]')
